...
- 各時のGitHubアカウントに課題提出用のリポジトリ (例: `アカウント名/is_training_course`) を作成し、課題を提出してください。
- 提出物確認のため、当該リポジトリに講師のアカウント (`iijimahr`) をコラボレーターとして追加してください。
...
以下の課題への回答を、課題提出用リポジトリの `01_linux_intro/assignment.md` に記述して提出してください。
